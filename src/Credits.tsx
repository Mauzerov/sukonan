export function Credits(props : { visible: boolean }) {
    return (
        <div className="credits" style={{
            ...
            <p>man pulling cart by Vectors Point from <a href="https://thenounproject.com/browse/icons/term/man-pulling-cart/" target="_blank" title="man pulling cart Icons" rel="noreferrer">Noun Project</a></p>
